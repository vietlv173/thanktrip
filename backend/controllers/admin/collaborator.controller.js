    ...
    User.findById(req.session.userid).exec(function (error, user) {
        if (error) {
            ...
            if (user === null) {
                ...
                res.render('admin/collaborator/create', {
                    userLogin: user,
            ...
            if (user === null) {
                ...
                User.findOne({username: req.body.username}).exec(function (err, user) {
                    if (user) {
                        ...
                        res.redirect('/admin/collaborator/create');
                    } else {
        ...
        if (err) {
            ...
            if (user === null) {
                ...
                User.findById(req.params.id).populate('customers').populate('banks').populate('transactions').exec(function (err, collaborator) {
                    ...
                    res.render('admin/collaborator/view', {
                        _: ejsHelpers,
                        collaborator: collaborator,
                        userLogin: user,
                        changePasswordSuccess: req.flash('changePasswordSuccess')
                    });
                })
            }
        }
        ...
        if (error) {
            ...
            if (user === null) {
                ...
                User.findById(req.params.id, function (err, collaborator) {
                    ...
                    res.render('admin/collaborator/change-password', {
                        collaborator: collaborator,
                        userLogin: user,
                        validateFormError: req.flash('validateFormError')
                    });
            ...
            if (user === null) {
                ...
                if (req.body.password && req.body.rePassword) {
                    ...
                    bcrypt.hash(req.body.password, 10, function (err, hash) {
                        ...
                        User.updateOne({_id: req.params.id}, {$set: {password: hash}}, function (err) {
                            if (err) return console.error(err);
